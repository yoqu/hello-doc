...
import com.iflytek.cbg.hello.docs.core.gen.ApiInfo;
import com.iflytek.cbg.hello.docs.core.gen.Gen;
...
public class DocMojo extends AbstractMojo {
  ...
  @Parameter(property = "hello.doc.generate.pb", defaultValue = "false")
  private boolean generatePB;

  @Parameter(property = "hello.doc.generate.js", defaultValue = "false")
