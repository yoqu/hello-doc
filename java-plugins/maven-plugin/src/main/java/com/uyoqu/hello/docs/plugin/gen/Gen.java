...
//          vo.setUrl(resolveUrl(clazz, clazz.getName()));
//          list.add(vo);
//        }
...
//              vo.setTime(timeline.time());
//              vo.setContent(timeline.content());
//              vo.setUrl(resolveUrl(method, method.getName()));
//              timelineVos.add(vo);
//            }
//          }
//        });
...
//
//    public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
//      ApiBasicFiled basicField = field.getAnnotation(ApiBasicFiled.class);
//      if (basicField == null) {
//        return;
//      }
//      ServiceDataVo dataVo = new ServiceDataVo(basicField);
//      if (StringUtils.isBlank(dataVo.getName())) {
//        dataVo.setName(field.getName());
//      }
//      if (StringUtils.isBlank(dataVo.getType())) {
//        dataVo.setType(field.getType().getSimpleName());
//      }
//      dataVos.add(dataVo);
//    }
...
//  }
//
//  private String resolveUrl(AnnotatedElement element, String name) {
//    if (element.isAnnotationPresent(ApiGlobalCode.class)) {
//      return "/basic-definition";
//    } else if (element.isAnnotationPresent(ApiDTO.class)) {
//      ApiDTO ann = element.getAnnotation(ApiDTO.class);
//      name = name.substring(name.lastIndexOf(".") + 1);
//      return "/dto/" + (StringUtils.isNotBlank(ann.enName()) ? ann.enName() : name);
//    } else if (element.isAnnotationPresent(ApiServiceDocs.class)) {
//      ApiServiceDocs ann = element.getAnnotation(ApiServiceDocs.class);
//      return "/service/" + (StringUtils.isBlank(ann.serviceName()) ? name : ann.serviceName().replaceAll("/", ".")) + "_" + ann.version();
//    } else {
//      return "";
//    }
//  }
